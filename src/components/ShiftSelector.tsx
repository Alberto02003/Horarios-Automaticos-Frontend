    ...
    <div className="space-y-0.5">
      {shiftTypes?.map((st) => (
        <button
          ...
          className="w-full flex items-center gap-2.5 px-3 py-2 rounded-xl text-sm hover:bg-p-lavender-light/50 text-left transition-colors"
        >
      ...
      {onRemove && (
        <>
          <div className="h-px bg-[#F0EDF3] my-1" />
          <button
