...
export default function GenerateDialog({ periodId, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 bg-pastel-pink-deep/20 backdrop-blur-sm flex items-center justify-center z-50 animate-fade-in">
      <div className="glass-card rounded-3xl p-8 w-full max-w-lg shadow-elevated animate-scale-in">
        <h3 className="text-lg font-bold text-warm-dark mb-5">Generar horario</h3>
